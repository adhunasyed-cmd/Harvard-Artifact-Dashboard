...
if not harvard_api:
    st.error("API key for Harvard not found in credentials.")
    st.stop()
...
st.markdown("<h1 style='text-align:center; color:black;'>🖼️ Harvard Artifact Dashboard</h1>", unsafe_allow_html=True)
